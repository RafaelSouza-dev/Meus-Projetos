...
<head>
    ...
    <script src="../js/bolsaFamilia.js"></script>
    <script src="../js/barraSuperior.js"></script>

    <link rel="stylesheet" href="../css/paciente/bolsaFamilia.css">
...
<header>
    ...
    <div class="containerPrincipal">
        <fieldset class="border p-4">
            <legend class="legend"><img src="../img/bolsaFamilia3.png" alt=""> Bolsa Família</legend>
            <div class="input-group col-8">
                <input type="text" class="form-control" placeholder="Digite o nome do paciente" aria-label="Recipient's username with two button addons">
                <button class="btn btn-outline-primary pesquisar" type="button" id="button-addonPesquisarFamilia">Pesquisar</button>
                <button class="btn btn-outline-success listar" type="button" id="button-addonListarFamilia">Listar</button>
            </div>
        </fieldset>
    </div>
    ...
    <div class="mostrarPaciente">
        <fieldset class="border p-4">
            ...
            <div class="containerInfo">
                ...
                <div id="info2">
                    <h6>Data da última pesagem: <span>00/00/000</span></h6>
                    <h6>Data da próxima pesagem: <span>00/00/000</span></h6>
                    <h6>Dependente: <span>nome(s) do(s) dependente(s) aqui</span></h6>
                    <br>
            ...
            <button class="btnInserirDados">Inserir os dados da pesagem</button>
            <hr>

            <form action="" method="POST">
                <div class="dependentes">
                    <div class="form-group">
                        <label>Nome do dependente:<span>*</span> </label>
                        <input type="text" class="form-control col-7" name="dependentes[]">

                        <label>NIS:<span>*</span> </label>
                        <input type="text" class="form-control col-3" name="dependentes[]">

                        <label>SUS: </label>
                        <input type="text" class="form-control col-3" name="dependentes[]">

                        <label>Data de nascimento:<span>*</span></label>
                        <input type="text" class="form-control col-2" name="dependentes[]">
                        <button type="button" id="btnAddDependente"> + Add depenentes </button>
                        <hr>
                    </div>
                </div>
                <label>Data da pesagem:<span>*</span></label>
                <input type="text" class="form-control col-2" name="dataPesagem">

                <label>Data da próxima pesagem:<span>*</span></label>
                <input type="text" class="form-control col-2" name="proximaPesagem">
                <button type="submit" class="btnSalvar  btn btn-outline-primary">Salvar</button>
                <button type="submit" class="btnCancelar btn btn-outline-danger">Cancelar</button>
            </form>
        </fieldset>
        <br>
    </div>
    ...
    <div class="listagem">
        <fieldset class="border p-4">
            ...
            <div class="containerInfo">
                ...
                <div id="info2">
                    <h6><strong>Última pesagem:</strong> <span>00/00/000</span></h6>
                    <label>Dependentes:</label>
                    <h6>Nome: <span>Fulano de Tal</span></h6>
                    <h6>NIS: <span>Fulano de Tal</span></h6>
                    <h6>SUS: <span>Fulano de Tal</span></h6>
                    <h6>Data de nascimento: <span>00/00/0000</span></h6>
                    <br>
