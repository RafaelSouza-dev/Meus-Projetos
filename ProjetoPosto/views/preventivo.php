...
<head>
    ...
    <link rel="stylesheet" href="../css/paciente/preventivo.css">
...
<header>
    ...
    <div class="barraLateralMenu">
        ...
        <a class="btnGrupoLateralMenu btnEntregaPreventivo" href="bolsaFamilia.php"><strong>Bolsa Família</strong></a>
    ...
    <div class="containerPrincipal">
        <fieldset class="border p-4">
            <legend class="legend"><img src="../img/simbolo.jpg" alt="">Preventivo</legend>
                <div class="input-group col-8">
                    ...
                    <button class="btn btn-outline-primary" type="button" id="button-addonPesquisarPreventivo">Pesquisar</button>
                    <button class="btn btn-outline-success" type="button" id="button-addonListarPreventivo">Listar</button>
                </div>
        </fieldset>  
    </div> 

    <!-- INÍCIO DA DIV QUE MOSTRA A ENTREGA DO EXAME AO ALGUM CONHECIDO DO PACIENTE -->
    <div class="mostrarPaciente">
        <fieldset class="border p-4">
            ...
            <div class="containerInfo">
                <div id="info1">
                    <h5>Nome: <span>Fulano de tal</span></h5>   
                ...
                <br>
                <div id="info2">
                    <label for=""><strong>Dados da última entrega</strong></label>
                    <h6>Data da coleta: <span>00/00/0000</span></h6>
                    <h6>Data da entrega: <span>00/00/0000</span></h6>
                    <h6>Entregou para: <span>Fulano de Tal</span></h6>
            ...
            <div class="dataExameClass">
                <label>Data da coleta:<span class="azul">*</span></label>
                <input type="text" class="form-control col-md-2" required>
                <label>Data da entrega:<span class="azul">*</span></label>
                <input type="text" class="form-control col-md-2" required>
            </div> 
            <button class="btnEntregaAConhecido">Click para entregar a alguém de confiança do(a) paciente</button>

            <form action="" method="POST">
                <div class="dadosPessoaConfiancaPaciente">
                    <label>Nome Completo: <span class="azul">*</span></label>
                    <input type="text" class="form-control col-md-8" required>
                    <label>CPF: <span class="azul">*</span></label>
                    <input type="text" class="form-control col-md-3"  maxlength="11"  required>
                </div> 
                <hr>                 
    ...
    <div class="listagem">
        <fieldset class="border p-4">
            ...
            <div class="containerInfo">
                ...
                <div id="info2">
                    <h6>Data da coleta: <span>00/00/000</span></h6>
                    <h6>Entregue a: <span>Fulano tal ou ao próprio paciente</span></h6>
                    <h6>Data da entrega: <span>00/00/000</span></h6>
                    <br>
