...
<head>
    ...
    <link rel="stylesheet" href="../css/paciente/notificacao.css">
...
<body>
    ...
    <div class="containerPrincipal">
        <fieldset class="border p-4">
            <legend class="legend"><img src="../img/notificacao.png" alt="">Notificações</legend>
                <div class="input-group col-8">
                    ...
                    <button class="btn btn-outline-primary" type="button" id="button-addonPesquisarNotificacao">Pesquisar</button>
                    <button class="btn btn-outline-success" type="button" id="button-addonListarNotificacao">Listar</button>
                </div>
        </fieldset>  
    </div>

     <!-- INÍCIO DA DIV QUE MOSTRA A FICHA DE NOTIFICAÇÃO -->
    <div class="mostrarPaciente">
        ...
        <div class="containerInfo">
            ...
            <div id="info2">
                <h6>Local da ocorrência: <span>Local Tal</span></h6>
                <h6>Município da ocorrência: <span>Local Tal</span></h6>
                <h6>Bairro da ocorrência: <span>Local Tal</span></h6>
                <h6>Data da ocorrência: <span>00/00/000</span></h6>
                <h6>Hora da ocorrência: <span>00/00/000</span></h6>
                <h6>Descrição do ocorrido:<span> O paciente foi encontrado... </span></h6>
                <br>
        ...
        <button class="btnFichaNotificacao">Ficha de notificação</button>
        <hr>   

            <form action="" method="POST">
                <div class="form-group DataHoraNotificacao">
                    <label>Data da ocorrência do evento:</label>
                    <input type="text" class="form-control col-md-2">
                    <label>Hora da ocorrência:</label>
                    <input type="text" class="form-control col-md-2">
                </div>

                <div class="localNotificacao form-group">
                    <label>Local da ocorrência :</label>
                    <input class="form-control  col-md-5"  placeholder="Residência ,no trabalho ...">

                    <label>Município da ocorrência :</label>
                    <input class="form-control  col-md-5"  placeholder="Queimados ...">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" placeholder="..."  rows="3" maxlength="200"></textarea>
                    <br>
                </div>             
